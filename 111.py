...
db = MySQLdb.connect(host="188.40.110.12",    # your host, usually localhost
                     user="diabollo_MonPi",         # your username
                     passwd="k_Y7!_tsVbj7hUg!a=",  # your password
                     db="diabollo_MonPi")        # name of the data base
